...
# https://glassdoor.co.in/Job/united-states-{a}-developer-jobs-SRCH_IL.0,13_IN1_KO14,30.htm?jobTypeIndeed=NJXCK&fromAge=1
...
# Fetch all the rows
#result_all fetch the job_source(link) from the database
...
#job_titles_strings has list of job_titles
...
# job_titles_strings = ['Python%20Developer', 'Java%20Developer', 'Angular%20Developer']
# job_titles_strings=['Java']
mycursor.close()
...
glassdoor, w2_contracts=Glassdoor(Commonfields(),result_all, job_titles_strings)
...
print("Data saved successfully in Excel file..")
